...
$(document).ready(function() {
  ...
  var obiwanQuotes = [ // Obi-Wan Kenobi Quotes
    ...
    var darthvaderQuotes = ["I find your lack of faith disturbing. \n-Darth Vader",
    ...
    var yodaQuotes = [      "Do. Or do not. There is no try. \n-Yoda",
    ...
    var lukeskywalkerQuotes = [      "I'll never turn to the Dark Side. You've failed, your highness. I am a Jedi, like my father before me. \n-Luke Skywalker",
      "If there's a bright center to the universe, you're on the planet that it's farthest from. \n-Luke Skywalker",
      "I'm Luke Skywalker. I'm here to rescue you. \n-Luke Skywalker",
      "The Force is strong in my family. My father has it. I have it. My sister has it. You have that power, too. \n-Luke Skywalker",
      "But I was going into Tosche Station to pick up some power converters! \n-Luke Skywalker"];
    
    var hansoloQuotes = ["Chewie...we're home. \n-Han Solo",
    ...
    var c3poQuotes = [      "I suggest a new strategy, R2: let the Wookiee win. \n-C-3PO",
